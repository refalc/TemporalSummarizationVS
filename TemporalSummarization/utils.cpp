...
CIndex::CIndex()
{
	...
	vStopWords.insert("¬");
	vStopWords.insert("¡≈«");
	vStopWords.insert("ƒŒ");
	vStopWords.insert("»«");
	vStopWords.insert(" ");
	vStopWords.insert("Õ¿");
	vStopWords.insert("œŒ");
	vStopWords.insert("Œ");
	vStopWords.insert("Œ“");
	vStopWords.insert("œ≈–≈ƒ");
	vStopWords.insert("œ–»");
	vStopWords.insert("◊≈–≈«");
	vStopWords.insert("—");
	vStopWords.insert("”");
	vStopWords.insert("«¿");
	vStopWords.insert("Õ¿ƒ");
	vStopWords.insert("Œ¡");
	vStopWords.insert("œŒƒ");
	vStopWords.insert("œ–Œ");
	vStopWords.insert("ƒÀﬂ");
	vStopWords.insert("»");
	vStopWords.insert("»À»");
	vStopWords.insert("¿");
	vStopWords.insert("ÕŒ");
	vStopWords.insert("“¿ ");
